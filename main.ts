...
export async function run(root: HTMLElement): Promise<void> {
  ...
  await mountTaskApp({
    root,
    task_id: "H000032-antisaccade",
    task_name: "Antisaccade Task",
    task_description: "HTML preview aligned to local psyflow Antisaccade procedure and parameters.",
    settings,
    subInfo,
    stimBank,
              ...
              [
                (_snapshot: TrialSnapshot, runtime: RuntimeView) => {
                  ...
                  return stimBank.get_and_format("block_break", {
                    ...
                    block_accuracy: summary.accuracy,
          ...
          [
            (_snapshot: TrialSnapshot, runtime: RuntimeView) => {
              ...
              return stimBank.get_and_format("good_bye", {
                ...
                total_accuracy: summary.accuracy,
                mean_rt_ms: summary.mean_rt_ms,
